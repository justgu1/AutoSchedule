...
final class LookupZipCodeTest extends TestCase
{
    #[Test]
    public function cache_hit_devolve_sem_chamar_o_provedor(): void
    {
        ...
        $result = (new LookupZipCode($cache, $provider))('01000000');
    ...
    public function cache_miss_chama_o_provedor_e_grava_o_resultado(): void
    {
        ...
        $result = (new LookupZipCode($cache, $provider))('20000000');
    ...
    public function cep_inexistente_devolve_null_sem_gravar_nada(): void
    {
        ...
        $result = (new LookupZipCode($cache, $provider))('99999999');
