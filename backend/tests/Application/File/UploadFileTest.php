...
namespace Tests\Application\File;
...
final class UploadFileTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->service = new UploadFile($this->storage, $this->files, $this->imageOptimizer, new LocalTempFileStore($this->tempPath));
    }
...
final class FakeImageOptimizer implements ImageOptimizer
{
    ...
    public function optimizeToWebp(string $sourcePath): OptimizedImage
    {
        ...
        // Cabeçalho RIFF/WEBP mínimo -- o suficiente pro `finfo` real (usado por `LocalTempFileStore::detectMimeType()`) reconhecer como `image/webp` sem precisar de um payload VP8 válido.
